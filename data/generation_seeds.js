...
window.genrationSeeds = {
    ...
    "modifiers": [
        ...
        "based on homeopathic remedies",
        "based on real-time feedback from your customers",
        "delivery",
        "driver",
        "enabler",
        "enhancer",
        ...
        "negotiator",
        "optimizer",
        "produced through sustainable sources",
        "pursuer",
        "repair service",
        "simplifier",
        "strategizer",
        "streamliner",
        "that donates to starving children",
        "that's good for the environment",
        "tool",
        "transformer",
        "vending machine",
        "which leverages off your buying power",
        "which self destructs when compromised",
        "with a beautiful UI"
    ]
}
